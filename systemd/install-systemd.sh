#!/bin/bash
# Diretta Host Daemon - Systemd Installation Script
#
...
echo "════════════════════════════════════════════════════════"
echo "  Diretta Host Daemon - Systemd Service Installation"
echo "════════════════════════════════════════════════════════"
echo ""
...
BINARY_PATH="$PROJECT_ROOT/bin/DirettaRenderer"
...
if [ ! -f "$BINARY_PATH" ]; then
    ...
    echo ""
    echo "Please ensure you have built the daemon:"
...
chmod +x "$INSTALL_DIR/DirettaRenderer"
echo "   Binary copied to $INSTALL_DIR/DirettaRenderer"
...
echo ""
echo "  5. Test IPC:"
echo "     echo '{\"cmd\":\"discover_targets\"}' | socat - UNIX-CONNECT:/tmp/diretta-renderer.sock"
echo ""
echo "════════════════════════════════════════════════════════"
